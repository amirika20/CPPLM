...
class CPPLMTrainer():
    ...
    def testing_step(self, batch):
        ...
        # print(intensities*5.017634289122833)
        # print(output.predicted_intensity.cpu()*5.017634289122833)
        return loss, metrics
...
if __name__ == "__main__":
    ...
    model = CPPLM(512, 4, 4).to("cuda")

    # # Building Trainder
    training_config = TrainingConfig(lr=0.00005,num_epochs=40, weight_decay=0.01)
